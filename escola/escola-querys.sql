...
SELECT FK_aluno_id, COUNT(*) as qntd_matriculadas FROM matriculas  GROUP BY   FK_aluno_id  HAVING  COUNT(*)  >= 2 ; 
...
tipo assim:Quantas matrículas existem por status, considerando os alunos vinculados?

Qual a média das notas por tipo de avaliação, considerando as matrículas correspondentes?

Qual a média de notas de cada matrícula, vinculando com suas avaliações?

Quais cidades possuem pelo menos 2 alunos com matrícula registrada?

Quais cursos tiveram mais de 1 turma no ano de 2025?

Quais turmas possuem pelo menos 3 matrículas?

Quais matrículas têm média de notas maior ou igual a 8.0?

Quais alunos possuem pelo menos 2 matrículas?

Quais tipos de avaliação possuem média maior ou igual a 7.5?